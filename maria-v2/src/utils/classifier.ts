// ============================================
// Maria V2 - LLM-Based Intent Classifier
// ============================================
...
const KEYWORD_PATTERNS: Record<CategoryCode, RegExp[]> = {
    ...
    CNS: [
        ...
        /\b(lectura del medidor|promedio de consumo)\b/i
    ],
    CON: [
        /\b(hola|buenos d[ií]as|buenas tardes|buenas noches|informaci[oó]n|horario|oficina)\b/i,
        /\b(estado de mi ticket|seguimiento|ticket|folio)\b/i
    ]
};
...
Responde ÚNICAMENTE con un JSON válido en este formato exacto:
{
  ...
  "reasoning": "explicación corta de por qué elegiste esta categoría"
    ...
    try {
        ...
        logger.warn({ error, input }, "LLM classification failed, using fallback");
