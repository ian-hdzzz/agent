...
app = FastAPI(
    title="Gobierno Queretaro - Vehicles Agent",
    description="LangGraph-based vehicle registration services agent",
    version="1.0.0",
    lifespan=lifespan,
)
...
async def query_agent(request: QueryRequest):
    ...
    try:
        ...
        folio_match = re.search(r"VEH-\d{8}-[A-Z0-9]{4}", response_text)
        if folio_match:
